...
```
New folder/
├── ProxyLogIQ/                        # Backend (Spring Boot)
│   ├── src/
│   │   ├── main/
│   │   │   ├── java/com/example/proxlogiq/
│   │   │   │   ├── config/
│   │   │   │   │   └── WebConfig.java              # CORS configuration
│   │   │   │   ├── controller/
│   │   │   │   │   └── LogController.java          # 8 REST endpoints
│   │   │   │   ├── dto/
│   │   │   │   │   └── LogUploadResponseDto.java
│   │   │   │   ├── entity/
│   │   │   │   │   ├── LogEntry.java               # Valid log JPA entity
│   │   │   │   │   └── InvalidLogEntry.java        # Invalid log JPA entity
│   │   │   │   ├── exception/
│   │   │   │   │   ├── ErrorResponse.java          # Error response DTO
│   │   │   │   │   └── GlobalExceptionHandler.java # @ControllerAdvice
│   │   │   │   ├── repository/
│   │   │   │   │   ├── LogEntryRepository.java
│   │   │   │   │   └── InvalidLogEntryRepository.java
│   │   │   │   └── service/
│   │   │   │       ├── AnalyticsService.java       # Metrics computation
│   │   │   │       ├── LogIngestionService.java    # Persistence layer
│   │   │   │       ├── LogParseException.java      # Custom exception
│   │   │   │       └── LogParserService.java       # Pipe-delimited parser
│   │   │   └── resources/
│   │   │       ├── application.properties          # PostgreSQL config
│   │   │       └── data/sample.log                 # Sample log file
│   │   └── test/
│   │       └── java/com/example/proxlogiq/service/
...
│   └── README.md
│
├── proxy-log-dashboard/              # Frontend (Next.js)
│   ├── src/
│   │   ├── app/
...
│   │   │   ├── TopEndpoints.tsx       # Top 10 slowest
